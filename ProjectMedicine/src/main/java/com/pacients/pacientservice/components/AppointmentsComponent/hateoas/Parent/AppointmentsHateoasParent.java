package com.pacients.pacientservice.components.AppointmentsComponent.hateoas.Parent;
...
@Component
public class AppointmentsHateoasParent implements RepresentationModelAssembler<AppointmentsTable, EntityModel<AppointmentsTable>> {
    @Override
